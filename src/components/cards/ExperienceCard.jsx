...
export default function ExperienceCard({ experience }) {
  return (
    <VerticalTimelineElement
      ...
      contentStyle={{
        background:
          "radial-gradient(circle at top right, rgba(34,211,238,0.14), rgba(8,16,30,0.92) 42%)",
        color: "#fff",
      ...
      date={
        <span className="text-xs md:text-sm text-cyan-200/90 font-medium">
          {experience.date}
        </span>
      }
    >
      <div className="text-left">
        ...
        <div className="text-sm md:text-base text-slate-300">{experience.company}</div>
