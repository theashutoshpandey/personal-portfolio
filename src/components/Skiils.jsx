  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full max-w-[1100px] flex flex-wrap justify-between gap-6 px-4"
      >
        {skills.map((category, idx) => (
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="w-full sm:w-[48%] bg-[rgba(10,18,36,0.7)] border border-cyan-400/20 shadow-[0_4px_24px_rgba(34,211,238,0.08)] rounded-2xl p-6 transition-all duration-300 hover:shadow-[0_0_28px_rgba(34,211,238,0.35)] hover:border-cyan-300"
          >
            ...
            <div className="flex flex-wrap gap-4">
              {category.skills.map((skill, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-2 border border-white/10 bg-[#0f172a] p-2 rounded-lg shadow-sm"
                >
                  {skill.image ? (
                    <img
                      src={skill.image}
